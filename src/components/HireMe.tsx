...
const HireMe = () => {
  return (
    <div 
    data-testid="hire-me"
    className="absolute left-4 -bottom-32 xl:bottom-28 xl:left-0 flex items-center justify-center overflow-hidden md:right-2 md:left-auto md:top-2 md:bottom-auto md:absolute lg:right-2 lg:left-auto lg:top-2 lg:bottom-auto lg:absolute">
