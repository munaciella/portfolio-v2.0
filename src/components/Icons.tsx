...
export const XIcon = ({ className, ...rest }: { className?: string } & React.SVGProps<SVGSVGElement>) => (
    <svg
...
export const GithubIcon = ({ className, ...rest }: { className?: string } & React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
...
export const LinkedInIcon = ({ className, ...rest }: { className?: string } & React.SVGProps<SVGSVGElement>) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
      height="1em"
  ...
  export const DribbbleIcon = ({ className, ...rest }: { className?: string } & React.SVGProps<SVGSVGElement>) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
      height="1em"
  ...
  export const SunIcon = ({ className, ...rest }: { className?: string } & React.SVGProps<SVGSVGElement>) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
  ...
  export const MoonIcon = ({ className, ...rest }: { className?: string } & React.SVGProps<SVGSVGElement>) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
  ...
  export const LinkArrow = ({ className, ...rest }: { className?: string } & React.SVGProps<SVGSVGElement>) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
      height={24}
